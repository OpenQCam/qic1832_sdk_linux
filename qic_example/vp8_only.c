    ...
    case DEV_ID_0:
        if(frame_count > 0)
        {
            ...
            if(frame_num>=30){
                ...
                printf("(VP8) frame rate= %2.2f fps \n", fps);
...
{	
    ...
    unsigned short vp8_width=1920;
    unsigned short  vp8_height = 1080;
 ...
 *************************************************/
    ...
    qic_config_codec_EU(DEV_ID_0,CODEC_VP8 );
    qic_change_resolution_EU(DEV_ID_0, SIMULCAST_STREAM0, vp8_width, vp8_height);
