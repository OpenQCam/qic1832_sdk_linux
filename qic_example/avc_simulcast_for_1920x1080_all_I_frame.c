...
{	
    ...
    s_AVCRes[1].width = 1920;
    s_AVCRes[1].height = 1080;

    s_AVCRes[2].width = 320;
    s_AVCRes[2].height = 180;
 ...
 *************************************************/
    ...
    qic_change_bitrate_EU(DEV_ID_0, SIMULCAST_STREAM0, 1500000);
    qic_change_frame_interval_EU(DEV_ID_0, SIMULCAST_STREAM0, (unsigned int) (10000000 / 15));
    qic_generate_key_frame_EU(DEV_ID_0, SIMULCAST_STREAM0, 1, 7000, 0);
    qic_change_profile_toolset_EU(DEV_ID_0, SIMULCAST_STREAM0, BASELINE_PROFILE, 0x29);
    qic_change_level_EU(DEV_ID_0, SIMULCAST_STREAM0, 0x28);
    ...
    qic_change_bitrate_EU(DEV_ID_0, SIMULCAST_STREAM1, 100000);
    qic_change_frame_interval_EU(DEV_ID_0, SIMULCAST_STREAM1, 10000000);
    qic_generate_key_frame_EU(DEV_ID_0, SIMULCAST_STREAM1, 1, 1000, 0);
    qic_change_profile_toolset_EU(DEV_ID_0, SIMULCAST_STREAM0, BASELINE_PROFILE, 0x29);
    qic_change_level_EU(DEV_ID_0, SIMULCAST_STREAM0, 0x28);
    ...
    qic_change_bitrate_EU(DEV_ID_0, SIMULCAST_STREAM2, 100000);
    qic_change_frame_interval_EU(DEV_ID_0, SIMULCAST_STREAM2, (unsigned int) (10000000 / 15));
    qic_generate_key_frame_EU(DEV_ID_0, SIMULCAST_STREAM2, 1, 1000, 0);
    qic_change_profile_toolset_EU(DEV_ID_0, SIMULCAST_STREAM0, BASELINE_PROFILE, 0x29);
    qic_change_level_EU(DEV_ID_0, SIMULCAST_STREAM0, 0x28);
